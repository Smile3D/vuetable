...
const sortByLocation = () => {
  console.log('dd')
  return getLocation.value.sort((a, b) => a.getLocation)
}

console.log(getLocation, 'getLocationgetLocationgetLocation')
</script>
    ...
    <div class="table">
      <div class="thead">
        <div class="tr">
          ...
          <div class="th" @click="sortByLocation()">Location</div>
