...
const newSortedByValue = computed(() => {
  ...
  return sortedDeliveries.sort(
    (a, b) =>
      ...
      a.location
        .localeCompare(b.location)
        .filter((item) => item.customer.name.includes(searchValue.value).toLowerCase())
  )
})
  ...
  <div class="table-wrapper">
    <div class="table-row-action">
      <div class="input-holder">
        <input v-model="searchValue.value" type="text" placeholder="Search by name" />
      </div>
    </div>
    <div class="table">
      <div class="thead">
