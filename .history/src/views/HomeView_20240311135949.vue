...
function onSort(columnKey) {
  ...
  if (sortByValue.value) {
    return deliveries.value.sort((a, b) => a[columnKey].localeCompare(b[columnKey]))
  } else {
    return deliveries.value.sort((a, b) => b[columnKey].localeCompare(a[columnKey]))
  }
}
  ...
  <div class="table-wrapper">
    ...
    <div class="table">
      <div class="thead">
        <div class="tr">
          <div class="th">Id</div>
          <div class="th" @click="onSort('customer')">Customer</div>
