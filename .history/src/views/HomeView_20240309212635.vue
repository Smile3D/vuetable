...
const getStatus = computed(() => {
  return deliveries.value.filter((item) => JSON.parse(JSON.stringify(item.status)))
})
// if (isProxy(deliveries)) {
//   getStatus.value = toRaw(deliveries)
// }
console.log(deliveries, 'getStatus')
</script>
    ...
    <div class="table">
      ...
      <div class="tbody">
        <div class="tr" v-for="delivery in deliveries" :key="delivery.customer.id">
          ...
          <div class="td status cancelled">{{ delivery.status }}</div>
          <div class="td">
