...
let delivered = ref('Delivered')
let shipped = ref('Shipped')
let pending = ref('Pending')
let cancelled = ref('Cancelled')
    ...
    <div class="table">
      ...
      <div class="tbody">
        <div class="tr" v-for="delivery in deliveries" :key="delivery.customer.id">
          ...
          <div class="td status" :class=[{ 'shipped': delivery.status === 'Shipped' }] >
            {{ delivery.status }}
          </div>
          <div class="td">
