  ...
  if (columnKey === 'location') {
    if (sortByValue.value) {
      deliveries.value.sort((a, b) =>
        a[columnKey].toUpperCase() < b[columnKey].toUpperCase() ? -1 : 0
      )
      console.log('111')
    } else {
      deliveries.value = deliveries.value.sort((a, b) => {
        console.log(a[columnKey].toUpperCase() > b[columnKey].toUpperCase() ? 1 : 0, '7777')
        return a[columnKey].toUpperCase() > b[columnKey].toUpperCase() ? 1 : 0
      })
      console.log('22')
    }
  } else {
